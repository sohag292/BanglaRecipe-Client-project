...
export default function Error() {
    ...
    return (
        <div>
            <section className="d-flex align-items-center h-screen p-4  bg-light text-dark">
                <div className="container d-flex flex-column align-items-center justify-content-center my-5">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-25 mb-4 text-gray-600">
